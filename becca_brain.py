...
BEHAVIOUR = (
    ...
    "COVER PAGE (very important): when you write an assignment, ALWAYS make a title "
    "page. Look in the assignment FILE and in the user's message for the title-page "
    "details: course number and name, assignment number and name, student name, student "
    "id, instructor, and date. The assignment file usually has these at the top, copy "
    "them exactly. Put each piece on its own line in cover_lines, in this order: course "
    "line, assignment line, then an empty string \"\", then student name line, instructor "
    ...
    "emojis. So do NOT tell the user she has to fix the font, the colours, or the "
    "headings in Word herself, you already did that. She only needs to read it and "
    "change any wording she wants.\n\n"
